...
public class MapperScannerConfigurer
    implements BeanDefinitionRegistryPostProcessor, // 方法：postProcessBeanFactory, postProcessBeanDefinitionRegistry (1)
  InitializingBean, // 方法：afterPropertiesSet (4)
  ApplicationContextAware, // 方法：setApplicationContext (3)
  BeanNameAware { // 方法：setBeanName (2)
  ...
  public void afterPropertiesSet() throws Exception {
    // 在bean初始化过程中进行basePackage的校验。initializeBean方法.
  ...
  public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) {
    ...
    /**
     * 扫描类路径下的Mapper配置文件，并生成代理. 最终会调用ClassPathMapperScanner类中的doScan方法.
     */
    scanner.scan(
